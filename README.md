...
### Продвинутая модель
- [x] Одна из: CatBoost / LightGBM / XGBoost  
- [x] Поиск 5–10 конфигураций (Grid/Random/SearchCV) с логом результатов  
- [x] Сравнение с baseline — выбран «победитель»  

### Интерпретация и ошибки
- [x] SHAP (summary + 1–2 waterfall) или permutation importance  
- [x] Показаны минимум 3 FN и 3 FP с кратким разбором причин и идеями улучшения  

### Репродуцируемость
- [x] Зафиксировал random_state/seed  
- [x] Вывел версии библиотек  
- [x] Убедился, что ноутбук запускается без ошибок  
